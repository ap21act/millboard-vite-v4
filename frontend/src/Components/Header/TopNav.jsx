...
const TopNav = ({ openCart }) => {
  ...
  return (
    <div className="relative z-50">
      <div className={`sticky top-0 z-50 hidden md:flex px-6 md:px-12 pt-4 md:pt-6 pb-4 md:pb-7 border-b-white-background bg-white-nav justify-between ${
        isScrolled ? 'py-2 md:py-3 shadow-lg' : 'py-4 md:py-6'
      }`}>
