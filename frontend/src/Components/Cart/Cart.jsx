  ...
  return (
    <section className="container mx-auto my-3 flex w-full flex-col gap-3 px-4">
      {cartItems.map((item, index) => (
        <div key={index} className="flex w-full border px-4 py-4 bg-white rounded-md shadow-md">
          <img
          ...
          <div className="ml-3 flex w-full flex-col justify-center">
            ...
            <p className="text-lg text-gray-700">Board Width:  {item.boardLength} mm x {item.boardBreadth} mm x {item.boardHeight} mm</p>
