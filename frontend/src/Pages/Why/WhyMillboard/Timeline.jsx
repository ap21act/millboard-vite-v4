  ...
  return (
    <div className="bg-primary py-16 px-4 text-white font-F37-light w-full relative">
      ...
      <div className="relative flex items-center justify-center">
          ...
          {/* Navigation Buttons positioned centrally on the left and right */}
          <button
            onClick={() => handleNavigation(-1)}
            disabled={currentIndex === 0}
            className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white hover:bg-green text-primary hover:text-white p-4 shadow-lg rounded-full disabled:opacity-50"
            aria-label="Previous"
          >
          ...
          <button
            ...
            className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-white hover:bg-green text-primary hover:text-white p-4 shadow-lg rounded-full disabled:opacity-50"
            aria-label="Next"
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-6 h-6">
