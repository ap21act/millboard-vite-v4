...
const footerData = [
  ...
  },
  {
    ...
    icon: 'https://res.cloudinary.com/ddtzxyzex/image/upload/t_Imporve and Sharpen/v1729611356/products/Home/calculator.svg', 
  ...
  },
  {
    ...
    icon: 'https://res.cloudinary.com/ddtzxyzex/image/upload/v1729599748/products/Icons/showroom2.svg',
    link: '/our-showrooms',
    isExternal: false
  },
];
          ...
          >
            <div className="flex flex-row items-center justify-center space-x-4 transform group-hover:scale-110 transition-transform duration-300">
              <img
                src={item.icon} 
                alt={item.title}
                className={`${item.title === 'Decking Calculator' ? 'w-10 h-10 sm:w-10 sm:h-10' : 'w-12 h-12 sm:w-16 sm:h-16'}`}
              />
